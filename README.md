...
The data was then trained on the Keras VGG16, InceptionV3, and ResNet50 models. The best performing model was the ResNet50. The training process is detailed on the attached Jupyter Notebook.
